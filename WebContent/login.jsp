              ...
              <div class="panel-body bg-light p25 pb15">
                ...
                <div class="section">
                  ...
                  <label for="username" class="field prepend-icon">
                    <input type="text" name="workerSn" id="username" class="gui-input" placeholder="请输入工号...">
                ...
                <div class="section">
                  ...
                  <label for="password" class="field prepend-icon">
                    <input type="password" name="workerPw" id="password" class="gui-input" placeholder="请输入密码...">
